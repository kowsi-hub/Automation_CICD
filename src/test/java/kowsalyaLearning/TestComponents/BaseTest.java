...
public class BaseTest {
	...
	public String email = "arkatkowsalya@gmail.com";
	...
	public WebDriver initializeDriver() throws IOException
	{
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir")+"//src//main//java//kowsalyaLearning//resources//GlobalData.properties");
		// \\Users\\Asus\\eclipse-workspace\\SeleniumFrameworkDesign\\ == System.getProperty("user.dir"
		prop.load(fis);
		...
		else if(browserName.equalsIgnoreCase("edge"))
		{
			System.setProperty("webdriver.edge.driver",
					"C://Users//Asus//Downloads//edgedriver//edgedriver.exe");
			this.driver=  new FirefoxDriver();
		}
		else if(browserName.equalsIgnoreCase("firefox"))
		{
			System.setProperty("webdriver.gecko.driver",
					"C:\\Users\\Asus\\Downloads\\geckodriver.exe");
			this.driver=  new FirefoxDriver();
		}
